...
exports.run = async (client, message, args) => {
  ...
  if (!args[0]) {
    ...
    const embed = new MessageEmbed()
      ...
      .setTimestamp()
      .setFooter(`© 2021, Nap Cafe • Total: ${client.commands.size} commands`, client.user.avatarURL)
      ...
      .setTitle(`<:algglubrok:845688789874901002> ${client.user.username}-Bot Command List <:algglubrok:845688789874901002>`)
...
exports.help = {
  name: 'help',
  description: 'Menampilkan daftar perintah bot Hoshimpnova.',
